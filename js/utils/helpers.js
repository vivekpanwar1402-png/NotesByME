...
(function () {
  ...
  var ICON_BODY = {
    ...
    gear:
      '<circle cx="12" cy="12" r="3.2"/><path d="M12 2v3.2M12 18.8V22M2 12h3.2M18.8 12h3.2M5.3 5.3l2.1 2.1M16.6 16.6l2.1 2.1M5.3 18.7l2.1-2.1M16.6 7.4l2.1-2.1"/>',
    help:
      '<circle cx="12" cy="12" r="9.2"/><path d="M9.4 9.4a2.7 2.7 0 0 1 5.2.8c0 1.8-2.6 2.4-2.6 2.4"/><path d="M12 17.2h.01"/>',
    note:
      '<path d="M14 2.5H6.7a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h10.6a2 2 0 0 0 2-2V7.7z"/><path d="M14 2.5v5.2h5.3"/><path d="M15.4 13.3H8.6M15.4 17H8.6M10.6 9.4H8.6"/>',
    ...
    calendarCheck:
      '<rect x="3.2" y="4.6" width="17.6" height="16.6" rx="2.4"/><path d="M16 2.5v4.2M8 2.5v4.2M3.2 10.2h17.6"/><path d="M9.2 15.2l2.2 2.2 3.6-4"/>',
    bulb:
      '<path d="M9.5 18.5h5"/><path d="M10.5 21.5h3"/><path d="M12 2.5a6.3 6.3 0 0 0-3.6 11.4c.7.6 1.1 1.2 1.3 2.1h4.6c.2-.9.6-1.5 1.3-2.1A6.3 6.3 0 0 0 12 2.5z"/>',
    arrowLeft: '<path d="M19.5 12h-15"/><path d="M11 5.5 4.5 12l6.5 6.5"/>',
    grid:
    ...
    flask:
      '<path d="M9.5 2.5h5"/><path d="M10.5 2.5v6.2L4.8 18a2.4 2.4 0 0 0 2.1 3.5h10.2a2.4 2.4 0 0 0 2.1-3.5L13.5 8.7V2.5"/><path d="M7.6 15h8.8"/>'
  };
